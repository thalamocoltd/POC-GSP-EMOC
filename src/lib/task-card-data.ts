...
export const AVAILABLE_PEOPLE: PersonOption[] = [
  { id: "p1", name: "Robert Chen (บค.วบก.)", role: "Direct Manager" },
  { id: "p2", name: "Sarah Williams (ทศค.)", role: "Division Manager" },
  { id: "p3", name: "David Thompson (วส.ทศค.)", role: "VP Operation" },
  { id: "p4", name: "Michael Anderson (ศท.ทศค.)", role: "Project Engineer" },
  { id: "p5", name: "Thomas Wilson (กศ.ทศค.)", role: "Electrical Engineering" },
  { id: "p6", name: "Jennifer Martinez (ทน.ทศค.)", role: "Mechanical Engineering" },
  { id: "p7", name: "Ozaki Furugori (ยยก.)", role: "Control & Instrument" },
  { id: "p8", name: "Emily Wong (ปค.ยยก.)", role: "Manager" },
  { id: "p9", name: "Karen Williams (ศศ.A ปค.)", role: "Manager" },
  { id: "p10", name: "James Harris (ศศ.B ปค.)", role: "Senior Engineer" },
  { id: "p11", name: "Lisa Anderson (ศศ.C ปค.)", role: "Technical Lead" },
  { id: "p12", name: "Mark Johnson (ศศ.D ปค.)", role: "Maintenance Lead" },
  { id: "p13", name: "Susan Chen (ปล.ยยก.)", role: "SHE Coordinator" },
  { id: "p14", name: "Peter Brown (ศศ.A ปล.)", role: "Operations Lead" },
];
...
export const TECHNICAL_DISCIPLINES: TechnicalDiscipline[] = [
  {
    ...
    directManager: "Emily Wong (ปค.ยยก.)",
    notApplicable: false,
    status: null,
    remark: "",
  },
  {
    ...
    directManager: "Karen Williams (ศศ.A ปค.)",
    notApplicable: false,
    status: null,
    remark: "",
  },
...
export const TECHNICAL_REVIEW_APPROVALS: TechnicalReviewApprovalRow[] = [
  {
    ...
    taTeam: "Thomas Wilson (กศ.ทศค.)",
    directManager: "Robert Chen (บค.วบก.)",
    status: null,
    remark: "",
  },
  {
    ...
    taTeam: "Jennifer Martinez (ทน.ทศค.)",
    directManager: "Karen Williams (ศศ.A ปค.)",
    status: null,
    remark: "",
  },
  ...
  },
  {
    ...
    taTeam: "Mark Johnson (ศศ.D ปค.)",
    directManager: "Sarah Williams (ทศค.)",
    status: null,
    remark: "",
  },
  {
    ...
    taTeam: "James Harris (ศศ.B ปค.)",
    directManager: "David Thompson (วส.ทศค.)",
    status: null,
    remark: "",
  },
  {
...
export const INITIATION_TASK_CARDS = {
  ...
  task3: {
    ...
    role: "VP Operation",
    assignedTo: "David Thompson (วส.ทศค.)",
    assignedOn: "15/01/2024 12:00",
    status: "In Progress" as const,
    selectedEngineer: "Michael Anderson (ศท.ทศค.)", // Display name
    comments: "",
    attachments: [],
  },
};
...
export const REVIEW_TASK_CARDS = {
  task1: {
    ...
    assignedTo: "Michael Anderson (ศท.ทศค.)",
